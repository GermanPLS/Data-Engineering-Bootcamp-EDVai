...
-- AVG
```sql
-- 1. Obtener el promedio de precios por cada categoria de producto. la clausula OVER (PARTICIONBY categoryID)especificaque se debe calcular el promedio de precios por cada valor unico de CategoryID en la tabla.
...
```
```sql
-- 3. Obtener el promedio de cantidad de productos vendidos por categoria (product_name, quantily_per_unit, unit_price, quantily, avgquantily) y ordenarlopor nombre de la categoria y nombre del producto
